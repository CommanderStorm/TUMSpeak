...
def generate_svg_code(character: str) -> str:
    ...
    if character == "A":
        return """
            ...
            <path d="M10,0l0,20l40,0l0,-20l-45,0Z" style="fill:#3070b3;"/>
            <path d="M10,40l0,40l50,0l0,-20l-50,0Z" style="fill:#3070b3;"/>
    ...
    if character == "B":
        return """
            <g id="B" transform="matrix(0.12,0,0,0.12,0,0)">
                    ...
                    <rect x="740.754" y="5.123" width="308.379" height="166.667" style="fill:#3070b3;"/>
                    <rect x="740.754" y="838.457" width="308.379" height="166.667" style="fill:#3070b3;"/>
                </g>
             """
    if character == "C":
        return """
            <g id="C" transform="matrix(0.12,0,0,0.12,0,0)">
    ...
    if character == "D":
        return """
            <g id="D" transform="matrix(0.12,0,0,0.12,0,0)">
    ...
    if character == "F":
        return """
            <g id="F" transform="matrix(0.12,0,0,0.12,0,0)">
                    ...
                    <rect x="3240.69" y="380.123" width="187.206" height="166.667" style="fill:#3070b3;"/>
    ...
    if character == "I":
        return """
            <g id="I" transform="matrix(0.12,0,0,0.12,0,0)">
    ...
    if character == "U":
        return """
            <g id="U" transform="matrix(0.12,0,0,0.12,0,0)">
                    ...
                    <rect x="3417.5" y="4640.5" width="500" height="166.667" style="fill:#3070b3;"/>
                </g>
             """
    if character == "V":
        return """
        ...
        return """
            <g id="Z" transform="matrix(0.12,0,0,0.12,0,0)">
                    ...
                    <path d="M4069.27,5401.33l-117.652,-118.051l-383.493,783.952l117.652,118.05l383.493,-783.951Z"
                          style="fill:#3070b3;"/>
                    <path d="M4068.12,4068.07l-499.999,-0.846l-0.282,166.666l499.999,0.847l0.282,-166.667Z"
                          style="fill:#3070b3;"/>
                </g>
             """
    if character == ",":
